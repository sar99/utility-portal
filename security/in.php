...
<body style="font-family: 'Poppins', sans-serif;">
    ...
    <div style="width: 100vw; text-align: center;font-decoration: bold; margin-top: 5vh; font-size: 2.8vh;"> Mark People Coming In </div>
    ...
    <table class="table" style="width: 85vw; margin: auto;margin-top: 1vh; ">
        ...
        <tbody>
                ...
                <?php 
                    ...
                    $sql="SELECT * FROM gatepass WHERE passStatus = '3' ORDER BY leaveTill ASC";
                        ...
                        while($row=mysqli_fetch_array($result))
                        {
                            ...
                            <td>
                                <form action='gatePassAction.php' method='post'>
                                    ...
                                    <input type='submit' name='in' value='Mark Back to Institute' class='btn btn-success'/>
                                </form>
                            </td>";
